    ...
    public class BlueprintElementHarvester : Component, ElementHarvester {
        ...
        public IEnumerable<ElementDescriptor> HarvestElements(HarvestElementsContext context) {
            ...
            var query =
                ...
                let baseElement = baseElementDescriptor == null ? null : _elementManager.Value.ActivateElement(baseElementDescriptor)
                select new ElementDescriptor(
                    baseElement == null ? null : baseElement.Descriptor.ElementType,
                    ...
                    GetCategory(blueprint)) {
                        ...
                        StateBag = new Dictionary<string, object> {
                            {"Blueprint", true},
                            {"ElementTypeName",  baseElement == null ? null : baseElement.Descriptor.TypeName}
                        }
                    };

            var descriptors = query.Where(e => e.ElementType != null).ToArray();
            _isHarvesting = false;
            return descriptors;
        }
